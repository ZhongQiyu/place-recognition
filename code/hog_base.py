...
The description of the class is mainly focused on the HOG descriptor,
...
class HogDescriptor():
    ...
    class HogTransformer(BaseEstimator, TransformerMixin):
        ...
        def transform(self, X, y=None):
            ...
            """
            def local_hog(X):
                output = hog(X, orientations=self.orientations, pixels_per_cell=self.pixels_per_cell,
    ...
    class HogPipeline():
        ...
        def __init__(self, classifier, classifier_params):
            ...
            """
            self.pipeline = Pipeline([('grayify', HogDescriptor.RGB2GrayTransformer()),
                                      ('hogify', HogDescriptor.HogTransformer(pixels_per_cell=(14, 14),
